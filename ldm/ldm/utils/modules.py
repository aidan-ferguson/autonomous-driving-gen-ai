# TODO: credit and citation, I copied this from diffinfinite but not sure if thats original, also might be able to remove functions from here
import torch
...
class ResnetBlock(nn.Module):
    ...
    def forward(self, x, time_emb = None, class_emb = None):
        ...
        if self.mlp is not None and (time_emb is not None or class_emb is not None):
            cond_emb = tuple(filter(lambda x: x is not None, (time_emb, class_emb)))
